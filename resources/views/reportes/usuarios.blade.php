...
<table class="tg table-marks">
    <tbody>
        <tr>
            <td class="tg-0pky head-table" colspan="6">Nombre</td>
            <td class="tg-0pky head-table" colspan="3">Correo</td>
            <td class="tg-0pky head-table" colspan="3">Tipo</td>
        </tr>
        ...
        @if ($usuarios->count() > 0)
            ...
            @foreach ($usuarios as $user)
                <tr class="subject-box padding-box">
                    ...
                    {{-- <td class="tg-0pky subject-box" colspan="3">
                        <div class="mark">
                            {{ $user->reserva->fch_desde }}-{{ $user->reserva->fch_hasta }}
                        </div>
                    </td> --}}
                </tr>
...
<h5>Derechos Reservados a <i>EVENTOS.BO</i></h5>
